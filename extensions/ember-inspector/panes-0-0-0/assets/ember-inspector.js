...
define('ember-inspector/adapters/chrome', ['exports', 'ember-inspector/adapters/web-extension'], function (exports, WebExtension) {
...
define('ember-inspector/adapters/firefox', ['exports', 'ember-inspector/adapters/web-extension'], function (exports, WebExtension) {
...
define('ember-inspector/adapters/web-extension', ['exports', 'ember-inspector/adapters/basic', 'ember', 'ember-inspector/config/environment'], function (exports, BasicAdapter, Ember, config) {
...
if (runningTests) {
  ...
  require("ember-inspector/app")["default"].create({"name":"ember-inspector","version":"1.10.0.31e395f2"});
}
